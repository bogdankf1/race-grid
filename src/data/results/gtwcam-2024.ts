...
// GT World Challenge America 2024 results
export const gtwcamResults2024: Record<string, EventResults> = {
  'gtwcam-2024-sonoma': { race: { overall: { driverIds: ['adelson', 'skeer'], teamId: 'wright-motorsports' }, classes: [{ className: 'Overall', podium: [{ position: 1, driverIds: ['adelson', 'skeer'], teamId: 'wright-motorsports' }] }] } },
  'gtwcam-2024-sebring': { race: { overall: { driverIds: ['hindman', 'pumpelly'], teamId: 'rennsport1' }, classes: [{ className: 'Overall', podium: [{ position: 1, driverIds: ['hindman', 'pumpelly'], teamId: 'rennsport1' }] }] } },
  'gtwcam-2024-cota': { race: { overall: { driverIds: ['milner', 'udell'], teamId: 'dxdt-racing' }, classes: [{ className: 'Overall', podium: [{ position: 1, driverIds: ['milner', 'udell'], teamId: 'dxdt-racing' }] }] } },
