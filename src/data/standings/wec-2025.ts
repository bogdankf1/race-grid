...
export const wecStandings2025: SeasonStandings = {
  ...
  drivers: [
    ...
    { position: 20, driverId: 'marciello', teamId: 'bmw', points: 27, wins: 0 },
    { position: 21, driverId: 'd-vanthoor', teamId: 'bmw', points: 26, wins: 0 },
    ...
    { position: 24, driverId: 'wittmann', teamId: 'bmw', points: 10, wins: 0 },
