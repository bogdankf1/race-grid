...
// F1 2026 standings — verified from formula1.com/en/results/2026, racingnews365.com (after Round 6 Monaco)
export const f1Standings2026: SeasonStandings = {
  drivers: [
    { position: 1, driverId: 'antonelli', teamId: 'mercedes', points: 156, wins: 5 },
    { position: 2, driverId: 'hamilton', teamId: 'ferrari', points: 90, wins: 0 },
    { position: 3, driverId: 'russell', teamId: 'mercedes', points: 88, wins: 1 },
    { position: 4, driverId: 'leclerc', teamId: 'ferrari', points: 75, wins: 0 },
    { position: 5, driverId: 'piastri', teamId: 'mclaren', points: 60, wins: 0 },
    { position: 6, driverId: 'norris', teamId: 'mclaren', points: 58, wins: 0 },
    { position: 7, driverId: 'verstappen', teamId: 'red-bull-racing', points: 43, wins: 0 },
    { position: 8, driverId: 'hadjar', teamId: 'red-bull-racing', points: 29, wins: 0 },
    { position: 9, driverId: 'lawson', teamId: 'racing-bulls', points: 26, wins: 0 },
    { position: 10, driverId: 'gasly', teamId: 'alpine', points: 26, wins: 0 },
    { position: 11, driverId: 'bearman', teamId: 'haas', points: 18, wins: 0 },
    { position: 12, driverId: 'colapinto', teamId: 'alpine', points: 15, wins: 0 },
  ...
  constructors: [
    { position: 1, teamId: 'mercedes', points: 244, wins: 6 },
    { position: 2, teamId: 'ferrari', points: 165, wins: 0 },
    { position: 3, teamId: 'mclaren', points: 118, wins: 0 },
    { position: 4, teamId: 'red-bull-racing', points: 72, wins: 0 },
    { position: 5, teamId: 'alpine', points: 41, wins: 0 },
    { position: 6, teamId: 'racing-bulls', points: 39, wins: 0 },
