...
const TEAMS: Record<string, Team> = {
  ...
  'all-inkl-munnich': { id: 'all-inkl-munnich', name: 'ALL-INKL.COM Münnich Motorsport', country: 'DE' },
  'ce-dealer-team': { id: 'ce-dealer-team', name: 'Construction Equipment Dealer Team', country: 'SE' },
  'gck': { id: 'gck', name: 'GCK', country: 'FR' },
  'gck-exclusive': { id: 'gck-exclusive', name: 'GCK Exclusiv-e', country: 'FR' },
  'grx-set': { id: 'grx-set', name: 'GRX-SET World RX Team', country: 'FI' },
  'hansen-world-rx': { id: 'hansen-world-rx', name: 'Hansen World RX Team', country: 'SE' },
  'hedstroms-motorsport': { id: 'hedstroms-motorsport', name: 'Hedströms Motorsport', country: 'SE' },
  'herve-knapick': { id: 'herve-knapick', name: 'Hervé Knapick', country: 'FR' },
  'impossible-rx-team': { id: 'impossible-rx-team', name: 'Impossible RX Team', country: 'HU' },
  'jdm-raptor-racing': { id: 'jdm-raptor-racing', name: 'JDM Raptor Racing', country: 'FR' },
  'juha-rytkonen-racing': { id: 'juha-rytkonen-racing', name: 'Juha Rytkönen Racing', country: 'FI' },
  'karai-motorsport': { id: 'karai-motorsport', name: 'Kárai Motorsport', country: 'HU' },
  'kms-horse-powertrain': { id: 'kms-horse-powertrain', name: 'KMS - HORSE Powertrain', country: 'SE' },
  'kristoffersson-motorsport': { id: 'kristoffersson-motorsport', name: 'Kristoffersson Motorsport', country: 'SE' },
  'kyb-eks-jc': { id: 'kyb-eks-jc', name: 'KYB EKS JC', country: 'SE' },
  'nyirad-motorsport': { id: 'nyirad-motorsport', name: 'Nyirád Motorsport', country: 'HU' },
  'oliver-bennett': { id: 'oliver-bennett', name: 'Oliver Bennett', country: 'GB' },
  ...
  'ibiza-farm-motorsport': { id: 'ibiza-farm-motorsport', name: 'Ibiza Farm Motorsport', country: 'US' },
  'carbahn-peregrine': { id: 'carbahn-peregrine', name: 'CarBahn with Peregrine Racing', country: 'US' },
  'mccumbee-mcaleer-racing': { id: 'mccumbee-mcaleer-racing', name: 'McCumbee McAleer Racing', country: 'US' },
  'czabok-simpson-racing': { id: 'czabok-simpson-racing', name: 'Czabok Simpson Racing', country: 'US' },
  'circle-h-racing': { id: 'circle-h-racing', name: 'Circle H Racing', country: 'US' },
  'rafa-racing': { id: 'rafa-racing', name: 'RAFA Racing', country: 'US' },
  'hattori-motorsports': { id: 'hattori-motorsports', name: 'Hattori Motorsports', country: 'US' },
  'team-tgm': { id: 'team-tgm', name: 'Team TGM', country: 'US' },
  'motorsports-in-action': { id: 'motorsports-in-action', name: 'Motorsports in Action', country: 'CA' },
  'stephen-cameron-racing': { id: 'stephen-cameron-racing', name: 'Stephen Cameron Racing', country: 'US' },
  'bryan-herta-autosport': { id: 'bryan-herta-autosport', name: 'Bryan Herta Autosport', country: 'US' },
  'victor-gonzalez-racing': { id: 'victor-gonzalez-racing', name: 'Victor Gonzalez Racing Team', country: 'PR' },
  'mmg': { id: 'mmg', name: 'Montreal Motorsport Group', country: 'CA' },
  'hart': { id: 'hart', name: 'HART (Honda Acura Research Team)', country: 'US' },
  'kmw-motorsports': { id: 'kmw-motorsports', name: 'KMW Motorsports with TMR Engineering', country: 'US' },
  'copeland-motorsports': { id: 'copeland-motorsports', name: 'Copeland Motorsports', country: 'US' },
  'lap-motorsports': { id: 'lap-motorsports', name: 'LAP Motorsports', country: 'US' },
  'unitronic-jdc-miller-motorsports': { id: 'unitronic-jdc-miller-motorsports', name: 'Unitronic JDC-Miller Motorsports', country: 'US' },
  // IMSA Michelin Pilot Challenge 2021-2025 additions
  'atlanta-speedwerks': { id: 'atlanta-speedwerks', name: 'Atlanta Speedwerks', country: 'US' },
  'awa-racing': { id: 'awa-racing', name: 'AWA Racing', country: 'CA' },
  'belgard-techniseal-racing': { id: 'belgard-techniseal-racing', name: 'Belgard & Techniseal Racing', country: 'US' },
  'bgb-motorsports': { id: 'bgb-motorsports', name: 'BGB Motorsports', country: 'US' },
  'black-swan-racing': { id: 'black-swan-racing', name: 'Black Swan Racing', country: 'US' },
  'capstone-motorsports': { id: 'capstone-motorsports', name: 'Capstone Motorsports', country: 'US' },
  'cb-motorsports': { id: 'cb-motorsports', name: 'CB Motorsports', country: 'US' },
  'fcp-euro': { id: 'fcp-euro', name: 'FCP Euro by Ricca Autosport', country: 'US' },
  'kelly-moss-road-and-race': { id: 'kelly-moss-road-and-race', name: 'Kelly-Moss Road and Race', country: 'US' },
  'kohr-motorsports': { id: 'kohr-motorsports', name: 'KohR Motorsports', country: 'US' },
  'la-honda-world-racing': { id: 'la-honda-world-racing', name: 'LA Honda World Racing', country: 'US' },
  'michael-johnson-racing': { id: 'michael-johnson-racing', name: 'Michael Johnson Racing', country: 'US' },
  'murillo-racing': { id: 'murillo-racing', name: 'Murillo Racing', country: 'US' },
  'nolasport': { id: 'nolasport', name: 'NOLASPORT', country: 'US' },
  'notlad-racing': { id: 'notlad-racing', name: 'Notlad Racing by RS1', country: 'US' },
  'pf-racing': { id: 'pf-racing', name: 'PF Racing', country: 'US' },
  'riley-motorsports': { id: 'riley-motorsports', name: 'Riley Motorsports', country: 'US' },
  'road-shagger-racing': { id: 'road-shagger-racing', name: 'Road Shagger Racing', country: 'US' },
  'starcom-racing': { id: 'starcom-racing', name: 'StarCom Racing', country: 'US' },
  'tgr-riley-motorsports': { id: 'tgr-riley-motorsports', name: 'TGR Riley Motorsports', country: 'US' },
  'van-der-steur-racing': { id: 'van-der-steur-racing', name: 'Van Der Steur Racing', country: 'US' },
  'volt-racing': { id: 'volt-racing', name: 'VOLT Racing with Archangel Motorsports', country: 'US' },
