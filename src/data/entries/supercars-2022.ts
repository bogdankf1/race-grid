...
export const supercarsEntries2022: EntryItem[] = [
  ...
  { driverId: 'fullwood', teamId: 'walkinshaw-andretti-united', carNumber: 25 },
  ...
  { driverId: 'holdsworth', teamId: 'grove-racing', carNumber: 10 },
