...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'search.circuits': 'Search circuits, countries…',
    'search.events': 'Search events, circuits…',
    'search.standings': 'Search drivers, teams…',
    ...
    'support.title': 'Support Race Grid',
    'support.subtitle': 'Race Grid is free and ad-free. If it has been useful, you can chip in to help cover hosting and the time spent keeping things accurate.',
    'support.ukraine.label': 'From Ukraine',
    'support.ukraine.method': 'monobank jar',
    'support.intl.label': 'International',
    'support.intl.method': 'Patreon · from $2/month',
    'support.thanks': 'Thank you for the help! 🙏',
    ...
    'settings.sessions': 'Show sessions',
    'settings.uiVersion': 'Interface',
    'settings.uiV1': 'Classic (V1)',
    'settings.uiV2': 'Modern (V2)',
    'v2.nextRace': 'Next race',
    'v2.startsIn': 'Starts in',
    'v2.viewDay': 'View day',
    'v2.agenda': 'Agenda',
    'v2.grid': 'Grid',
    'v2.noRaces': 'No races this month',
    'v2.thisMonth': 'This month',
    'v2.events': 'events',
    'v2.series': 'series',
    'v2.cd.days': 'days',
    'v2.cd.hours': 'hrs',
  ...
  uk: {
    ...
    'search.series': 'Пошук серій…',
    'search.circuits': 'Пошук трас, країн…',
    'search.events': 'Пошук подій, трас…',
    'search.standings': 'Пошук пілотів, команд…',
    ...
    'support.title': 'Підтримати Race Grid',
    'support.subtitle': 'Race Grid безкоштовний і без реклами. Якщо він був корисний — можна закинути копієчку на хостинг і час, який витрачається на підтримку даних.',
    'support.ukraine.label': 'З України',
    'support.ukraine.method': 'Банка monobank',
    'support.intl.label': 'З-за кордону',
    'support.intl.method': 'Patreon · від $2/міс',
    'support.thanks': 'Дякую за підтримку! 🙏',
    ...
    'group.stock': 'Стоккар',
    'group.rally': 'Ралі',
    'group.motorcycle': 'Мотоспорт',
    'group.special': 'Спеціальні події',
    ...
    'settings.sessions': 'Показувати сесії',
    'settings.uiVersion': 'Інтерфейс',
    'settings.uiV1': 'Класичний (V1)',
    'settings.uiV2': 'Сучасний (V2)',
    'v2.nextRace': 'Наступна гонка',
    'v2.startsIn': 'Старт через',
    'v2.viewDay': 'Переглянути день',
    'v2.agenda': 'Розклад',
    'v2.grid': 'Сітка',
    'v2.noRaces': 'Цього місяця гонок немає',
    'v2.thisMonth': 'Цього місяця',
    'v2.events': 'подій',
    'v2.series': 'серій',
    'v2.cd.days': 'днів',
    'v2.cd.hours': 'год',
