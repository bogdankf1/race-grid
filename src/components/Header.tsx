...
import { SideRail } from './v2/SideRail'
  ...
  if (uiVersion === 'v2') {
    return (
      <>
        ...
        <header ref={headerRef} className="v2-topbar">
          <div className="v2-topbar-inner">
            <Link href="/" style={{ textDecoration: 'none' }}>
              <h1 className="font-display v2-wordmark" style={{ margin: 0 }}>{t('app.title', locale)}</h1>
            </Link>
            <div className="rg-header-controls" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <button
                className="rg-control rg-settings-btn"
