---
description: Add a new season year with full calendar data for all 27 racing series
user_invocable: true
...
3. For each of the 27 series, use `WebSearch` to find the official calendar for the specified year
