---
description: Add a new season year with full calendar data for all 20 racing series
user_invocable: true
...
3. For each of the 20 series, use `WebSearch` to find the official calendar for the specified year
